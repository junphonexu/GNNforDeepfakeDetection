...
if __name__ == '__main__':
    fileDir = "F:/final/FF++/manipulated_sequences/FaceShifter"

    train_facename = open('FaceShifter_train.txt', mode='a')
    train_label = open('FaceShifter_train_label.txt', mode='a')

    test_facename = open('FaceShifter_test.txt', mode='a')
    test_label = open('FaceShifter_test_label.txt', mode='a')
