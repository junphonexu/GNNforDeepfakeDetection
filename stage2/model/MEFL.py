...
class MEFARG(nn.Module):
    def __init__(self, num_classes=4, backbone='swin_transformer_base'):
    ...
    def forward(self, x):
        ...
        cl = torch.mean(cl, dim=1)
        # cl_edge = torch.mean(cl_edge, dim=1)
        # print(cl.shape, cl_edge.shape)
        return cl, cl_edge
